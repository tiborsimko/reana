...
## [0.95.0](https://github.com/tiborsimko/reana/compare/0.9.4...0.95.0) (2026-09-22)


### ⚠ BREAKING CHANGES

* **helm:** Upgrade the REANA cluster, UI and clients together for OIDC; legacy access tokens and SSO configuration no longer work. Configure an external HTTPS issuer or enable development Keycloak, and supply the audience, required role and client credentials. Back up the database before applying migrations, which permanently remove legacy tokens, and link existing accounts to issuer subjects before login. Returning to the legacy token schema requires restoring the backup. Use reana-client login after client-setup-environment, which no longer exports a token or accepts --namespace, --instance-name or --insecure-url. Admit notebook images that honour NOTEBOOK_ARGS and rename conflicting user secrets. Keep Keycloak identity storage persistent where it must survive pod replacement, and renew delegated GitLab webhook authorisation.
...
* **helm:** add support for Kubernetes 1.31 ([#822](https://github.com/tiborsimko/reana/issues/822)) ([834b3eb](https://github.com/tiborsimko/reana/commit/834b3eb76718bd28a925832201c4fd213f30eda5))
...
* **helm:** bump Redis cache image from 5.0.5 to 8.6.3 ([#966](https://github.com/tiborsimko/reana/issues/966)) ([f9416fb](https://github.com/tiborsimko/reana/commit/f9416fb3534a76ed31608a473387df7c35192277))
...
* **config:** add new reana-demo-lhcb-run2-b2jpsik example ([#928](https://github.com/tiborsimko/reana/issues/928)) ([c90496a](https://github.com/tiborsimko/reana/commit/c90496ac5a825e804c99a2db3bde98b1ff1823a7))
...
* **helm:** add configurable UI security headers ([#945](https://github.com/tiborsimko/reana/issues/945)) ([9fe2c49](https://github.com/tiborsimko/reana/commit/9fe2c49b1e6e6d7fc43c5ac4f1d4eaf1ee752263))
* **helm:** add configurable workspace listing limits ([#900](https://github.com/tiborsimko/reana/issues/900)) ([cdcaa96](https://github.com/tiborsimko/reana/commit/cdcaa96c957c65fa046fa54447fa6b55e7899b1b))
* **helm:** add controller uWSGI ConfigMaps ([#953](https://github.com/tiborsimko/reana/issues/953)) ([ecdaffc](https://github.com/tiborsimko/reana/commit/ecdaffc4e80d437b2e8099d093ffed2d24625a93))
...
* **helm:** add k8s resource request/limits for infra components ([#889](https://github.com/tiborsimko/reana/issues/889)) ([865bd99](https://github.com/tiborsimko/reana/commit/865bd998547755f1e3e97133639917f30c8ac99f))
...
* **helm:** add quota management secret configuration ([#908](https://github.com/tiborsimko/reana/issues/908)) ([301fc2a](https://github.com/tiborsimko/reana/commit/301fc2a962a6401eb730ebaace455b7f3f0df9a2))
* **helm:** add quota period Helm support ([#931](https://github.com/tiborsimko/reana/issues/931)) ([37af266](https://github.com/tiborsimko/reana/commit/37af266f60ad2fd11cdc7a7add4417313b9e1f57))
...
* **helm:** add token management secret configuration ([#950](https://github.com/tiborsimko/reana/issues/950)) ([fe71ab3](https://github.com/tiborsimko/reana/commit/fe71ab361986f3e215e1bf0509886e4e0ce8f8c9))
...
* **helm:** add value to customise vetted container images ([#902](https://github.com/tiborsimko/reana/issues/902)) ([207b10f](https://github.com/tiborsimko/reana/commit/207b10f9aba3064a8ca546bf36e119f2e9fc8ef6))
...
* **helm:** allow automatic access token issuance ([#927](https://github.com/tiborsimko/reana/issues/927)) ([4d85bc1](https://github.com/tiborsimko/reana/commit/4d85bc10b679044a181e960aa0a40a8a8bd35549)), closes [#925](https://github.com/tiborsimko/reana/issues/925)
...
* **helm:** allow custom session lifetime ([#937](https://github.com/tiborsimko/reana/issues/937)) ([2ea8abf](https://github.com/tiborsimko/reana/commit/2ea8abf4cd1e56b97ffe7ba62daa06a344ea20d4))
* **helm:** allow customising minimum Kubernetes job user ID ([#956](https://github.com/tiborsimko/reana/issues/956)) ([1cd83ab](https://github.com/tiborsimko/reana/commit/1cd83abcbbc76cecca8b33e6bdb53a8c3a7985b1))
...
* **helm:** deploy OIDC authentication and bundled Keycloak ([#976](https://github.com/tiborsimko/reana/issues/976)) ([0a4f306](https://github.com/tiborsimko/reana/commit/0a4f306ce1ed459c5e78dbf5f95685d4b564bd4d))
* **helm:** enrich disabled local development configuration ([#983](https://github.com/tiborsimko/reana/issues/983)) ([798a5ca](https://github.com/tiborsimko/reana/commit/798a5caba211fe68052ac280c37c251295721d22))
...
* **helm:** pass vetted image policy to job controllers ([#970](https://github.com/tiborsimko/reana/issues/970)) ([c31f587](https://github.com/tiborsimko/reana/commit/c31f5870c4a0928cd5e19772b1119cdcabe73fe2))
...
* **helm:** remove default GitLab host ([#938](https://github.com/tiborsimko/reana/issues/938)) ([eac01cb](https://github.com/tiborsimko/reana/commit/eac01cb0e277079431442849a7b6839c91f6f728))
* **helm:** replace FLASK_ENV with FLASK_DEBUG for debug mode ([#946](https://github.com/tiborsimko/reana/issues/946)) ([83df5a9](https://github.com/tiborsimko/reana/commit/83df5a97ef01320a49c3cbf6db5747cfff7843fa))
...
* **helm:** support fsGroup-based shared storage access ([#984](https://github.com/tiborsimko/reana/issues/984)) ([df18220](https://github.com/tiborsimko/reana/commit/df182201cc578db8773e5cb2a8f7733278dbd9bb))
...
* **helm:** support sandboxed workflow specification validation ([#980](https://github.com/tiborsimko/reana/issues/980)) ([7042200](https://github.com/tiborsimko/reana/commit/7042200d5381d09d5672d0a837edbb97362adc1e))
* **helm:** support separate runtime namespace for workflow pods ([#955](https://github.com/tiborsimko/reana/issues/955)) ([2d46c83](https://github.com/tiborsimko/reana/commit/2d46c83922b289f313ec7b9e8ab600551a60d9db)), closes [#954](https://github.com/tiborsimko/reana/issues/954)
* **helm:** use a named ACL user for the Redis cache ([#966](https://github.com/tiborsimko/reana/issues/966)) ([e236d66](https://github.com/tiborsimko/reana/commit/e236d6617500714e541c925d9f903983fad65167))
...
* **reana-dev:** add --issue option to git-checkout-pr ([#948](https://github.com/tiborsimko/reana/issues/948)) ([7d82ed6](https://github.com/tiborsimko/reana/commit/7d82ed608a12e6b463935de1270cd7242c7ecd4c))
...
* **reana-dev:** add create-branch option to git-upgrade command ([#958](https://github.com/tiborsimko/reana/issues/958)) ([d08cb5c](https://github.com/tiborsimko/reana/commit/d08cb5cb5e6fc4c04bc71e14375df7cdfdc61d19))
...
* **reana-dev:** add git-iteration-rollover command ([#960](https://github.com/tiborsimko/reana/issues/960)) ([bc7654e](https://github.com/tiborsimko/reana/commit/bc7654e5a30248730478152c5d022af5a8f9647b))
* **reana-dev:** add Go client installation and selection ([#1002](https://github.com/tiborsimko/reana/issues/1002)) ([37a0fee](https://github.com/tiborsimko/reana/commit/37a0feee188e8cbb632322f7d184f3f8c0c497bc)), closes [#1001](https://github.com/tiborsimko/reana/issues/1001)
...
* **reana-dev:** adopt saved client connection settings ([#1013](https://github.com/tiborsimko/reana/issues/1013)) ([1377c63](https://github.com/tiborsimko/reana/commit/1377c637d583ee271747127a63d2d26df3a64abc))
...
* **reana-dev:** auto-create multi-arch release-docker builder ([#959](https://github.com/tiborsimko/reana/issues/959)) ([aa9f5e5](https://github.com/tiborsimko/reana/commit/aa9f5e57217f0e0443a3a0b511c3b04b9d1d2b1f))
* **reana-dev:** avoid shell interpolation in git-upgrade command ([#958](https://github.com/tiborsimko/reana/issues/958)) ([39b3140](https://github.com/tiborsimko/reana/commit/39b31401d485b433c0403fe0ceeb3ed22cc1ffec))
...
* **reana-dev:** register reana-datastore-s3fs component ([#979](https://github.com/tiborsimko/reana/issues/979)) ([ca70738](https://github.com/tiborsimko/reana/commit/ca707381272c0294d629def3b0e451e08c7bd063))
* **reana-dev:** reuse existing local branch in git-checkout-pr ([#947](https://github.com/tiborsimko/reana/issues/947)) ([6296b66](https://github.com/tiborsimko/reana/commit/6296b6628cc664e5db0d77d2e9581a66bcb76a50))
...
* **scripts:** add local CERN CoreDNS helper ([#989](https://github.com/tiborsimko/reana/issues/989)) ([6e700b4](https://github.com/tiborsimko/reana/commit/6e700b4a299e7052ced6852938b374d8a193f80b))
* **scripts:** upgrade Kueue to v0.17.0 ([#940](https://github.com/tiborsimko/reana/issues/940)) ([4f2ba90](https://github.com/tiborsimko/reana/commit/4f2ba905773815d5172376d11347f5f97361f673))
...
* **config:** use glob for egg-info in flake8 exclude ([#896](https://github.com/tiborsimko/reana/issues/896)) ([bee69e4](https://github.com/tiborsimko/reana/commit/bee69e47090e9746a8c071d95a1dfa62485a1141)), closes [#882](https://github.com/tiborsimko/reana/issues/882)
...
* **helm:** add quota management secret default ([#982](https://github.com/tiborsimko/reana/issues/982)) ([50d6cd2](https://github.com/tiborsimko/reana/commit/50d6cd2bdaac4550841917c673f7c26c699d7e77))
...
* **helm:** only mount CERN/EOSC SSO secrets when configured ([#966](https://github.com/tiborsimko/reana/issues/966)) ([1456eb6](https://github.com/tiborsimko/reana/commit/1456eb60f51eff1d75f5577f5f7359e6f0dee81d))
* **helm:** only mount GitLab OAuth secrets when configured ([#966](https://github.com/tiborsimko/reana/issues/966)) ([2b4658c](https://github.com/tiborsimko/reana/commit/2b4658c11bedc79a642c3a1f1fa547e29cd3c51b))
* **helm:** quote Helm template values consistently ([#939](https://github.com/tiborsimko/reana/issues/939)) ([32f3d8f](https://github.com/tiborsimko/reana/commit/32f3d8f95e0099eb1dc5c5b9b1ae6972b4af5f96))
* **helm:** remove null default for quota update policy ([#941](https://github.com/tiborsimko/reana/issues/941)) ([307584d](https://github.com/tiborsimko/reana/commit/307584dfb329a3b579610dbcd8523bbecec3f560))
* **helm:** require explicit DB, MQ, cache and OpenSearch secrets ([#966](https://github.com/tiborsimko/reana/issues/966)) ([bc9303f](https://github.com/tiborsimko/reana/commit/bc9303f1f5bfee138b94fb9322e3441bb51ed31a))
* **helm:** require explicit REANA_SECRET_KEY ([#966](https://github.com/tiborsimko/reana/issues/966)) ([b2eeacc](https://github.com/tiborsimko/reana/commit/b2eeaccd4fbda34708752b176937a35b2ab2300b))
...
* **helm:** update Traefik chart repository ([#992](https://github.com/tiborsimko/reana/issues/992)) ([c275bf2](https://github.com/tiborsimko/reana/commit/c275bf2c254865dc69d9fdaccc94ceb1d90efd8b)), closes [#991](https://github.com/tiborsimko/reana/issues/991)
* **helm:** use alpha image tag for dask operator ([#942](https://github.com/tiborsimko/reana/issues/942)) ([10702a9](https://github.com/tiborsimko/reana/commit/10702a9ded4091dcbd9195e04cac8b4f4a17cf79))
...
* **helm:** use int64 for large numeric template values ([#941](https://github.com/tiborsimko/reana/issues/941)) ([c817d7a](https://github.com/tiborsimko/reana/commit/c817d7ae60f452e4a09702a1c28e721828adac1d))
* **reana-dev:** activate environment using dot-source command ([#965](https://github.com/tiborsimko/reana/issues/965)) ([08739a9](https://github.com/tiborsimko/reana/commit/08739a90a512de9b84063ee8afaaa2317402a01d)), closes [#962](https://github.com/tiborsimko/reana/issues/962)
...
* **reana-dev:** avoid multi-manifest indices in kind load ([#961](https://github.com/tiborsimko/reana/issues/961)) ([8eaf55d](https://github.com/tiborsimko/reana/commit/8eaf55d4e7ed597762c8807eed1f5a4ad7709fc7))
...
* **reana-dev:** detect versions in git-create-release-commit ([#936](https://github.com/tiborsimko/reana/issues/936)) ([0243ef7](https://github.com/tiborsimko/reana/commit/0243ef72afb2d532b388d424f2678c520a790179))
* **reana-dev:** enable `run-example` fallback legacy checks ([#928](https://github.com/tiborsimko/reana/issues/928)) ([90f1467](https://github.com/tiborsimko/reana/commit/90f1467f7e31d1d28f408f5d7dbc9ce581069337))
* **reana-dev:** handle multi-match in git-upgrade-shared-modules ([#936](https://github.com/tiborsimko/reana/issues/936)) ([bc946d5](https://github.com/tiborsimko/reana/commit/bc946d5c6c2e37b9aba29da12ec02726d47f5f8d))
...
* **reana-dev:** install all client components in one pip call ([#946](https://github.com/tiborsimko/reana/issues/946)) ([25e4593](https://github.com/tiborsimko/reana/commit/25e4593006bb7fefe5519f23f97c966efd334eba))
...
* **reana-dev:** upgrade shared modules in both setup/pyproject ([#934](https://github.com/tiborsimko/reana/issues/934)) ([d3ac466](https://github.com/tiborsimko/reana/commit/d3ac4663802d3abfa3cf50cc96641c616e56703c))
...
* **reana-dev:** use correct `--python-tests` flag in tests ([#946](https://github.com/tiborsimko/reana/issues/946)) ([01a44b9](https://github.com/tiborsimko/reana/commit/01a44b9b5872531576071a5a77556f66097329f4))
* **reana-dev:** use current PR references in git-checkout-pr ([#988](https://github.com/tiborsimko/reana/issues/988)) ([e1d4a62](https://github.com/tiborsimko/reana/commit/e1d4a6246080b3f9c7bc4ed58413079c465da917)), closes [#987](https://github.com/tiborsimko/reana/issues/987)
...
* **reana-dev:** check local branches with `git show-ref` ([#969](https://github.com/tiborsimko/reana/issues/969)) ([35cba20](https://github.com/tiborsimko/reana/commit/35cba20c2a5814337f09f1fbac5b236095a4f406))
* **reana-dev:** drop `shell=True` from remaining hot paths ([#969](https://github.com/tiborsimko/reana/issues/969)) ([1758677](https://github.com/tiborsimko/reana/commit/1758677de9f97a0e29bb9f6ca3c127c5d1f8e88c))
* **reana-dev:** run `git-fetch` components in parallel ([#969](https://github.com/tiborsimko/reana/issues/969)) ([0050b04](https://github.com/tiborsimko/reana/commit/0050b049a8b9840e1ca47c284d80b73cacb2ccd2))
* **reana-dev:** speed up git-status on macOS ([#969](https://github.com/tiborsimko/reana/issues/969)) ([5824e15](https://github.com/tiborsimko/reana/commit/5824e155b98ea03add5350e813a07516759c9485))
...
* **pytest:** drop pytest-reana and use pytest directly ([#949](https://github.com/tiborsimko/reana/issues/949)) ([5d681f6](https://github.com/tiborsimko/reana/commit/5d681f6b2df7b6db530a90f259cfc9a52d5db2fe))
...
* **python:** pin setuptools below 81 ([#926](https://github.com/tiborsimko/reana/issues/926)) ([75303e4](https://github.com/tiborsimko/reana/commit/75303e459011f14eae421feb5236ec4a4c597ab8))
...
* **release-please:** upgrade action to v5 ([#998](https://github.com/tiborsimko/reana/issues/998)) ([360a686](https://github.com/tiborsimko/reana/commit/360a686d985938f47cbc4ed32e997a4cfc7a9811))
* **run-tests:** add usage help and refactor options ([#930](https://github.com/tiborsimko/reana/issues/930)) ([5bb9b8d](https://github.com/tiborsimko/reana/commit/5bb9b8de446e27de0fcdc89f0fce805a81d01783))
...
* **helm:** align README with chart secret hardening ([#966](https://github.com/tiborsimko/reana/issues/966)) ([2d8c86f](https://github.com/tiborsimko/reana/commit/2d8c86fc5c483f7c18f8fc2a11dfc95e40e91b51))
...
* **helm:** document all configurable environment variables ([#901](https://github.com/tiborsimko/reana/issues/901)) ([060c02f](https://github.com/tiborsimko/reana/commit/060c02f524d52ffd962b953a723a8b3f1946dda0)), closes [#899](https://github.com/tiborsimko/reana/issues/899)
* **helm:** document local HTCondor testing ([#989](https://github.com/tiborsimko/reana/issues/989)) ([5aab9fe](https://github.com/tiborsimko/reana/commit/5aab9fe70d699cf751defbee97a81a287696d387))
* **helm:** document REANA_RATELIMIT_SLOWER and SLOWEST ([#966](https://github.com/tiborsimko/reana/issues/966)) ([fd6609e](https://github.com/tiborsimko/reana/commit/fd6609e3e4a301def6bc076e6aea9468a1fe0960))
* **helm:** improve Slurm compute backend documentation ([#985](https://github.com/tiborsimko/reana/issues/985)) ([371ec22](https://github.com/tiborsimko/reana/commit/371ec2238a328e6d8743e2b71052d4f1b55bd137))
